...
<!-- <img src="https://media.giphy.com/media/qgQUggAC3Pfv687qPC/giphy.gif" alt="Developer" width="100%" /> -->

## 🚀 About Me

💻 Full Stack Developer passionate about building modern web applications.  
🌱 Currently working with **Next.js, React, TypeScript, Node.js, and MongoDB**.  
🎯 Focused on creating scalable, responsive, and user-friendly applications.  
🚀 Software Developer at **EZsofttech**.  
...
- ⚛️ Next.js & React Projects
- 🏥 Hospital & NGO Management Systems
- 📊 Admin Dashboards
- ☁️ Cloud Integrations (Cloudinary, AWS)
...
💡 I enjoy building clean, responsive websites and solving real-world problems through code.

---

### 📫 Connect With Me

- 💼 <a href="https://www.linkedin.com/in/aviral-singh28" target="_blank">LinkedIn</a>
